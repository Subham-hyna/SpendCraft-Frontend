        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="text-base sm:text-lg font-light text-gray-900 dark:text-gray-100 truncate">
              {expense.title || expense.sub_category_id?.name}
            </h3>
            <p className="text-lg sm:text-xl font-light text-gray-900 dark:text-gray-100 shrink-0">
            ...
            {expense.datetime ? (
              <>
                <span className="flex items-center gap-1">
                  ...
                  {convertFromUTC(expense.datetime as string, DateFormats.DD_MMM)}
                </span>
                <span>•</span>
                <span>
                  {convertFromUTC(expense.datetime as string, DateFormats.HH_MM_12)}
                </span>
              </>
            ) : (
              <span className="flex items-center gap-1">
